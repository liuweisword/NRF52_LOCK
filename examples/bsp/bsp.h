 ...
 *
 * @param[in]   type               Type of peripherals used.//外设类型
 * @param[in]   ticks_per_100ms    Number of RTC ticks for 100 ms.//100ms RTC时钟
 * @param[in]   callback           Function to be called when button press/event is detected.//按键按下或者事件发生时调用的时间
 *
